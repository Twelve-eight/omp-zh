...
const V = load('G:/omp works/Tools/omp-zh/work/omp-dl-1824.exe');
...
const checks = [
  ...
  ['stopcap cluster=1e6', has('kLn = 1000000, KGa = 4000, bLn = 1000000, SLn = 1000000')],
  ['session cap=1e6', has('XLn = 1000000')],
  ['yield ladder=1e6', has('Hwt = 1000000')],
  ...
  ['leak tunnel cwd+hide', has('cwd: p6(), windowsHide: true })')],
  ['leak ssh cwd+hide', has('cwd: t0t.homedir(), windowsHide: true })')],
  ...
  ['console probe forced true', has('function vJt(e) {\n  if (e.platform !== "win32")\n    return false;\n  return true;\n}')],
  ['catalog v4 forced-choice true=0', (d.match(/"deepseek-v4-(flash|pro)"[\s\S]{0,2500}?supportsForcedToolChoice: true/g) || []).length === 0],
  ['encstale regex extended (uQs)', has('encrypted content')],
  ['encstale regex extended (J0r)', has('encrypted content could not be decrypted')],
